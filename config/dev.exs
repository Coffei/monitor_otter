...
config :monitor_otter, MonitorOtterWeb.Mailer,
  ...
  tls: String.to_atom(System.get_env("MONITOR_OTTER_SMTP_USE_TLS")),
  auth: String.to_atom(System.get_env("MONITOR_OTTER_SMTP_AUTH")),
  port: String.to_integer(System.get_env("MONITOR_OTTER_SMTP_PORT")),
